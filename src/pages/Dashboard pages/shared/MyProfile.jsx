...
const MyProfile = () => {
    ...
    return (
        <div >
            ...
            <div className='p-10  rounded-2xl h-full flex gap-6 shadow my-5'>
                <div className=''>
            ...
            <div className='grid grid-cols-4 justify-evenly items-center gap-5 my-10 bg-base-100'>
                <div className='text-center p-4 shadow rounded-2xl'>
