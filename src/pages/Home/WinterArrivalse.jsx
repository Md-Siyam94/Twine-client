    ...
    return (
        <div className=' relative w-full  h-[600px] overflow-hidden'>
           ...
           <div  className="relative z-10 text-white flex flex-col justify-center items-center h-full">
            <h1 className='lg:text-7xl md:text-4xl text-2xl font-semibold '>Winter Arrival</h1>
            <p className='my-6 w-5/12 text-center'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quidem blanditiis quibusdam eaque aperiam quis iste atque omnis, neque sapiente ut.</p>
