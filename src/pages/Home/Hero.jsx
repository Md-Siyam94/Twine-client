...
const Hero = () => {
    return (
        <div className='max-h-[calc(100vh-20vh)] lg:px-30 px-6 flex py-10 lg:py-0  items-center'>
            <div className='flex-1  mt-0 '>
               ...
               <div className=''>
                 <Link to={"/products"} className=' flex hover:bg-teal-700 gap-2 lg:w-48 w-40 px-6 lg:py-4 py-2 mt-3  text-white  lg:text-lg rounded-full bg-teal-600'>Let's Shop <FaShopify className='text-xl' /></Link>
               </div>
            </div>
