    ...
    return (
        <div className='max-h-[calc(100vh-20vh)] lg:px-30 px-10 flex py-10 lg:py-0  items-center'>
            <div className='flex-1  mt-0 '>
                ...
                <Link to={"/products"} className='flex items-center  gap-2 w-48 px-10 py-4 mt-3  text-white text-lg rounded-full bg-teal-600'>Let's Shop <FaShopify className='text-xl' /></Link>
            </div>
