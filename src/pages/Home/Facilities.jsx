...
const Facilities = () => {
    return (
        <div className='max-w-7xl mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 justify-center py-24 px-5 items-stretch '>
            <motion.div whileHover={{ scale: 1.03 }} className='py-14 hover:bg-base-200 rounded-2xl shadow px-5 '>
