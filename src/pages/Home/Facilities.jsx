...
const Facilities = () => {
    return (
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 bg-base-200 py-24 px-4 lg:px-20  items-center '>
            <motion.div whileHover={{ scale: 1.03 }} className='py-14 hover:bg-green-200 rounded-2xl bg-base-100 shadow px-5 '>
